        ...
        <div class="inner inner01">
            ...
            <form id="form" method="post">
                <div>
                    ...
                    <label for="userName">
                        <input class="mt10" name="originName" id="userName" placeholder="성명" maxlength="20" onkeyup="joinNameCheck()">
                    </label>
                    <div class="msg" id="joinNameMsg"></div>
                    <label for="userId">
                        <input class="mt10" name="userId" id="userId" placeholder="사용자 이름" maxlength="20" onkeyup="joinIdCheck()">
                    </label>
                    <div class="msg" id="joinIdMsg"></div>
                    <label for="userPassword">
                        <input class="mt10" type="password" name="userPassword" id="userPassword" placeholder="비밀번호" onkeyup="joinPwCheck()">
                    </label>
